...
/***** module 0 start *****/
/***** src\pages\index.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"container\">\n    <div class=\"userinfo\" @click=\"handleViewTap($event)\">\n      <img class=\"userinfo-avatar\" background-size=\"cover\" :src=\"( userInfo.avatarUrl )\"/>\n      <div class=\"userinfo-nickname\">{{ userInfo.nickName }}</div>\n    </div>\n\n    <panel>\n      <div class=\"title\" slot=\"title\">测试数据绑定</div>\n\n      <span class=\"info\">{{normalTitle}}</span>\n      <span class=\"info\">{{setTimeoutTitle}}</span>\n      <span class=\"info\">{{mixin}}</span>\n      <span class=\"info\">{{mynum}}</span>\n      <span class=\"info\">{{now}}</span>\n      <button @click=\"plus(a,$event)\" size=\"mini\">  +  </button>\n    </panel>\n\n    <panel>\n      <div class=\"title\" slot=\"title\">其它测试</div>\n      <button @click=\"toast($event)\" size=\"mini\">第三方组件</button>\n      <button @click=\"communicate($event)\" size=\"mini\">组件通信</button>\n      <button @click=\"tap($event)\" size=\"mini\">混合TAP事件</button>\n    </panel>\n\n    <panel>\n      <div class=\"title\" slot=\"title\">测试并发网络请求</div>\n      <div>返回结果: <span>{{netrst}}</span></div>\n      <button @click=\"request($event)\" size=\"mini\"> 点我发起10个请求 </button>\n    </panel>\n\n    <panel>\n      <div class=\"title\" slot=\"title\">测试组件</div>\n\n      <span class=\"testcounter\">计数组件1: </span>\n      <div class=\"counterview\">\n        <counter1  v-on:index-emit=\"counterEmit\"></counter1>\n      </div>\n\n      <span class=\"testcounter\">计数组件2: </span>\n\n      <div class=\"counterview\">\n        <counter2  v-bind:num.sync=\"mynum\"></counter2>\n      </div>\n    </panel>\n\n    <panel>\n      <div class=\"title\" slot=\"title\">测试组件Repeat</div>\n      <div key=\"key\" v-for=\"(index, item) in (groupList)\">\n        <group  v-bind:grouplist.once=\"item\" v-bind:indexa.once=\"index\"></group>\n      </div>\n    </panel>\n\n    <panel>\n      <div class=\"title\" slot=\"title\">测试列表</div>\n      <list></list>\n    </panel>\n\n    <toast></toast>\n  </div>\n"},/***** module 0 end *****/
...
__wepy_require(2).default.$createApp(_default, {"routes":{"pages/index":5},"style":[4,12,18,30,31,32,34,43],"components":{},"apis":{}});
...
var _app = __wepy_require(19);

var _app2 = _interopRequireDefault(_app);

var _page = __wepy_require(20);

var _page2 = _interopRequireDefault(_page);

var _component = __wepy_require(21);

var _component2 = _interopRequireDefault(_component);

var _event = __wepy_require(22);

var _event2 = _interopRequireDefault(_event);

var _base = __wepy_require(23);

var _base2 = _interopRequireDefault(_base);

var _util = __wepy_require(24);

var _util2 = _interopRequireDefault(_util);

var _mixin = __wepy_require(25);

var _mixin2 = _interopRequireDefault(_mixin);

var _wx = __wepy_require(26);
...
function(module, exports, __wepy_require) {var g = __wepy_require(27);

// IOS 10.0.1 may cause IOS crash.
g.Promise = __wepy_require(28);
g.regeneratorRuntime = __wepy_require(29);
...
/***** module 4 start *****/
/***** src\app.wpy *****/
function(module, exports, __wepy_require) {module.exports = ".container{height:100%;display:flex;flex-direction:column;align-items:center;justify-content:space-between;box-sizing:border-box}\n"},/***** module 4 end *****/
...
var _list = __wepy_require(6);

var _list2 = _interopRequireDefault(_list);

var _panel = __wepy_require(7);

var _panel2 = _interopRequireDefault(_panel);

var _counter = __wepy_require(8);

var _counter2 = _interopRequireDefault(_counter);

var _group = __wepy_require(9);

var _group2 = _interopRequireDefault(_group);

var _wepyComToast = __wepy_require(10);

var _wepyComToast2 = _interopRequireDefault(_wepyComToast);

var _test = __wepy_require(11);
...
var _groupitem = __wepy_require(33);
...
/***** module 12 start *****/
/***** src\pages\index.wpy *****/
function(module, exports, __wepy_require) {module.exports = ".userinfo{display:flex;flex-direction:column;align-items:center}.userinfo-avatar{width:40px;height:40px;border-radius:50%}.userinfo-nickname{color:#aaa}\n"},/***** module 12 end *****/


/***** module 13 start *****/
/***** src\components\list.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"list\">\n  <div>\n    <button @click=\"add($event)\" size=\"mini\">添加列表</button>\n  </div>\n    <div v-for=\"(index, item) in (list)\">\n      <div @click=\"tap($event)\" class=\"mylist\">\n        <span>{{item.id}}</span>: {{item.title}}\n      </div>\n    </div>\n  </div>\n"},/***** module 13 end *****/
...
/***** module 15 start *****/
/***** src\components\counter.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div :class=\"'counter ' + (style)\">\n    <button @click=\"plus($event)\" size=\"mini\">  +  </button>\n    <button @click=\"minus($event)\" size=\"mini\">  -  </button>\n    <span class=\"count\"  v-bind:class.once=\"{red: num > 55, green: num &lt; 45}\"> {{num}} </span>\n  </div>\n"},/***** module 15 end *****/


/***** module 16 start *****/
/***** src\components\group.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"group\">\n    <span class=\"id\">{{grouplist.id}}. </span>\n    <span class=\"name\" @click=\"tap($event)\">{{grouplist.name}}</span>\n    <div>\n      <div v-for=\"(index, item) in (grouplist.list)\">\n        <groupitem  v-bind:gitem.once=\"item\"></groupitem>\n      </div>\n    </div>\n  </div>\n"},/***** module 16 end *****/
...
var _component2 = __wepy_require(21);
...
var _vue = __wepy_require(37);

var _vue2 = _interopRequireDefault(_vue);

var _vueRouter = __wepy_require(38);
...
var _axios = __wepy_require(40);

var _axios2 = _interopRequireDefault(_axios);

var _query = __wepy_require(41);

var _device = __wepy_require(42);
...
var global = module.exports = typeof window !== 'undefined' && window.Math === Math ? window : typeof self !== 'undefined' && self.Math === Math ? self : undefined;
},/***** module 27 end *****/
...
/***** module 30 start *****/
/***** src\components\list.wpy *****/
function(module, exports, __wepy_require) {module.exports = ".mylist:odd{color:red}.mylist:even{color:green}\n"},/***** module 30 end *****/


/***** module 31 start *****/
/***** src\components\panel.wpy *****/
function(module, exports, __wepy_require) {module.exports = ".panel{width:100%;margin-top:10px;text-align:left;font-size:12px;padding-top:10px;padding-left:25px;padding-bottom:10px;border:1px solid #ccc}.panel .title{padding-bottom:10px;font-size:14px;font-weight:bold}.panel .info{padding:7.5px}.panel .testcounter{margin-top:7.5px;position:absolute}.panel .counterview{margin-left:60px}\n"},/***** module 31 end *****/


/***** module 32 start *****/
/***** src\components\counter.wpy *****/
function(module, exports, __wepy_require) {module.exports = ".counter{text-align:left;font-size:12px}.count{font-size:18px;font-weight:bold}.count.red{color:red}.count.green{color:green}\n"},/***** module 32 end *****/
...
/***** module 35 start *****/
/***** src\components\groupitem.wpy *****/
function(module, exports, __wepy_require) {module.exports = "\n  <div class=\"groupitem\">\n    --<span class=\"id\">{{gitem.childid}}.</span>\n    <span class=\"name\" @click=\"tap($event)\"> {{gitem.childname}}</span>\n  </div>\n"},/***** module 35 end *****/
